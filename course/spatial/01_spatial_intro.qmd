...
::: callout-note
Normally we use the above plot to determine the number of dimensions to use for downstream kNN and clustering. Here, because we've subset it looks like we should pick fewer than the first 15 PCs, but in practice...
:::
